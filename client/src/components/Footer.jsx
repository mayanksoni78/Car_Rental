...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#05091B] text-slate-400 border-t border-[#10172B]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        
        {/* Main Footer Grid */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-16 pb-12 border-b border-[#10172B]">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs font-semibold">
              <li>
                <Link to="/" className="hover:text-[#8EA860] transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/cars" className="hover:text-[#8EA860] transition-colors">
                  Browse Cars
                </Link>
              </li>
              <li>
                <Link to="/my-booking" className="hover:text-[#8EA860] transition-colors">
                  My Bookings
                </Link>
              </li>
              <li>
                <Link to="/reviews" className="hover:text-[#8EA860] transition-colors">
                  Customer Reviews
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs">
              <li className="flex items-center gap-2.5 text-slate-300">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[#8EA860] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="mt-6 pt-4 border-t border-[#10172B] flex items-center gap-4 text-xs">
